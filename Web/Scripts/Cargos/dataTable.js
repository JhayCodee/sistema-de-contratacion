$(document).ready(function () {
    ...
    $('#tablaCargos').DataTable({
        ...
        columns: [
            ...
            { "data": "CodigoCargo" },
            { "data": "NombreCargo" },
            { "data": "RangoSalarioInicial" },
            { "data": "RangoSalarialFinal" },
            {
                "data": null,
                "render": function (data, type, row) {
                    return '<a href="' + editarUrl + '/' + row.IdCargo + '" class="btn btn-primary mx-1">Editar</a>';
                }
            },
        ],
        language: {
        ...
        buttons: [
            {
                ...
                action: function (e, dt, node, config) {
                    window.location.href = "/Cargos/AgregarCargo";
                }
            },
            {
                extend: "excel",
